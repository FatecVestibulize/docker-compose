...
docker build --build-arg VITE_API_URL=http://localhost:8080 -t $DOCKER_USERNAME/vestibulize-front-web:$VERSION ../front-web
docker build --build-arg VITE_API_URL=http://localhost:8080 -t $DOCKER_USERNAME/vestibulize-front-web:latest ../front-web
